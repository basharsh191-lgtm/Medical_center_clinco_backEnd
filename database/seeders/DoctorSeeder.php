    ...
    public function run(): void
    {
        $doctors=[
            [
                ...
                'specialization_id' => 1,
                'clinic_id' => 1,
                'image' => url('storage/doctor_picture/3.jpg'),
            ...
            [
                ...
                'specialization_id' => 7,
                'clinic_id' => 7,
                'image' => url('storage/doctor_picture/4.jpg'),
                'experience_years' => rand(2, 20),
                ...
                'specialization_id' => 9,
                'clinic_id' => 9,
                'image' => url('storage/doctor_picture/5.jpg'),
                'experience_years' => rand(2, 20),
            ...
            [
                ...
                'specialization_id' => 3,
                'clinic_id' => 3,
                'image' => url('storage/doctor_picture/6.jpg'),
                'experience_years' => rand(2, 20),
            ...
            [
                ...
                'specialization_id' => 2,
                'clinic_id' => 2,
                'image' => url('storage/doctor_picture/7.jpg'),
                'experience_years' => rand(2, 20),
            ...
            [
                ...
                'specialization_id' => 1,
                'clinic_id' => 1,
                'image' => url('storage/doctor_picture/8.jpg'),
                'experience_years' => rand(2, 20),
                'bio' => "خبير في مجاله الطبي ولديه خبرة واسعة في التعامل مع الحالات الحرجةالقلبية.",
            ],
        ];
