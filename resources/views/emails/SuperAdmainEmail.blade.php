...
<head>
    ...
    <title>بيانات الدخول إلى لوحة التحكم - Clinco</title>
    <style type="text/css">
        /* لضمان قراءة الخطوط الافتراضية بشكل جميل إذا لم يتحمل خط كايرو */
...
<body style="margin: 0; padding: 0; background-color: #e0f2f7; direction: rtl;" bgcolor="#e0f2f7">
    ...
    <!-- الجدول الرئيسي المحيط بالإيميل بالكامل وبديل الـ Container -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px; background-color: #ffffff; border-radius: 30px; overflow: hidden; border: 1px solid #c9e3ef; box-shadow: 0 15px 30px rgba(0,0,0,0.05);" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td align="center" style="padding: 10px 30px 20px 30px; color: #1e4a5f; font-size: 15px; line-height: 1.6; text-align: center;">
                            زميلنا العزيز، تم إنشاء حسابك الرسمي على <strong>منصة Clinco الطبية</strong> بنجاح.
                            يمكنك الآن استخدام البيانات التالية للوصول إلى لوحة التحكم (Dashboard) الخاصة بك ومباشرة مهامك:
                        </td>
                    </tr>

                    <!-- منطقة البيانات (البريد والباسورد) المصممة بدقة لتناسب الـ Email Clients -->
                    <tr>
                        <td style="padding: 0 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #fafefe; border-radius: 20px; padding: 20px; border: 1px solid #d4edf5;" bgcolor="#fafefe">
                                ...
                                <!-- حقل البريد -->
                                <tr>
                                    <td align="right" style="padding-bottom: 5px; color: #7a9eb3; font-size: 12px; font-weight: 700;">👤 اسم المستخدم / البريد الإلكتروني:</td>
                                </tr>
                                <tr>
                                ...
                                <!-- حقل كلمة المرور -->
                                <tr>
                                    <td align="right" style="padding-bottom: 5px; color: #7a9eb3; font-size: 12px; font-weight: 700;">🔑 كلمة المرور الافتراضية:</td>
                                </tr>
                                <tr>
                                    <td align="left" style="padding: 10px 14px; background-color: #ffffff; border: 1px solid #e2f0f5; border-radius: 10px; color: #0b5e7e; font-weight: 600; font-size: 14px; direction: ltr; font-family: Arial, sans-serif;" bgcolor="#ffffff">
                                        {{ $password }}
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate;">
                                <tr>
                                    <td align="center" style="border-radius: 25px; background-color: #146b8a;" bgcolor="#146b8a">
                                        <a href="{{ url('/login') }}" target="_blank" style="font-size: 14px; font-weight: bold; color: #ffffff; padding: 12px 35px; display: inline-block; background-color: #146b8a; border-radius: 25px; border: 1px solid #146b8a; font-family: 'Segoe UI', Tahoma, sans-serif;">💻 الدخول إلى لوحة التحكم</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <!-- التنبيه الأمني باللون الأحمر اللطيف المتوافق -->
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #fff5f5; border-radius: 30px; border: 1px solid #ffe3e3;" bgcolor="#fff5f5">
                                <tr>
                                    <td align="center" style="padding: 10px 15px; color: #e74c3c; font-size: 12px; font-weight: 700; line-height: 1.4;">
                                        🔒 أمن البيانات أولويتنا: يرجى تغيير كلمة المرور الافتراضية فور تسجيل دخولك الأول لحماية صلاحياتك.
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 30px; border-top: 1px solid #dcebf2; color: #7aa9bf; font-size: 11px; line-height: 1.5; text-align: center;">
                            هذا البريد الإلكتروني مخصص لموظفي المركز فقط ويحتوي على معلومات حساسة.<br />
                            منظومة Clinco الطبية المتكاملة © {{ date('Y') }}
                        </td>
                    </tr>
